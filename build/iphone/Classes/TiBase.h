...
// in simulator we redefine to format for BinneyTimothy_Week3 Developer console
...
{\
	NSString * exceptionName = [@"org.binneytimothy_week3." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.binneytimothy_week3";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIBinneyTimothy_Week3NativeItemNone = -1, 
	UIBinneyTimothy_Week3NativeItemSpinner = -2,
	UIBinneyTimothy_Week3NativeItemProgressBar = -3,
	
	UIBinneyTimothy_Week3NativeItemSlider = -4,
	UIBinneyTimothy_Week3NativeItemSwitch = -5,
	UIBinneyTimothy_Week3NativeItemMultiButton = -6,
	UIBinneyTimothy_Week3NativeItemSegmented = -7,
	
	UIBinneyTimothy_Week3NativeItemTextView = -8,
	UIBinneyTimothy_Week3NativeItemTextField = -9,
	UIBinneyTimothy_Week3NativeItemSearchBar = -10,
	
	UIBinneyTimothy_Week3NativeItemPicker = -11,
	UIBinneyTimothy_Week3NativeItemDatePicker = -12,
	
	UIBinneyTimothy_Week3NativeItemInfoLight = -13,
	UIBinneyTimothy_Week3NativeItemInfoDark = -14,
	
	UIBinneyTimothy_Week3NativeItemDisclosure = -15,
	
	UIBinneyTimothy_Week3NativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all BinneyTimothy_Week3 instances of
