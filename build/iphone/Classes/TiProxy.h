...
//Rare exceptions to indicate a bug in the _binneytimothy_week3 code (Eg, function that a subclass should have implemented)
...
/**
 The base class for BinneyTimothy_Week3 proxies.
 */
