...
/**
 The base class for all BinneyTimothy_Week3 modules
 */
...
/**
 BinneyTimothy_Week3 Platform calls this method on startup.
 */
-(void)startup;

/**
 BinneyTimothy_Week3 Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 BinneyTimothy_Week3 Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 BinneyTimothy_Week3 Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 BinneyTimothy_Week3 Platform calls this method on resume.
 @param sender The sender of the event.
 */
