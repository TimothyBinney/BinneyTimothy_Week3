...
/**
 Base class for all BinneyTimothy_Week3 views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the BinneyTimothy_Week3 view hierarchy (such as wrapped iOS UIViews) was touched.
