...
@interface BinneyTimothy_Week3Object : KrollCoverageObject {
#else
@interface BinneyTimothy_Week3Object : KrollObject {
#endif
@private
...
extern NSString * BinneyTimothy_Week3$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	BinneyTimothy_Week3Object *_binneytimothy_week3;
    KrollObject* console;
	BOOL shutdown;
