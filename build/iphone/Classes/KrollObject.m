...
//@interface BinneyTimothy_Week3Object : NSObject
//@end

@interface BinneyTimothy_Week3Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[BinneyTimothy_Week3Object class]])
		{
			for (NSString *key in [[(BinneyTimothy_Week3Object*)o modules] allKeys])
			{
