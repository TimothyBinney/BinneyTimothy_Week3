 ...
 * to send analytic data that can be viewed on the BinneyTimothy_Week3 Dashboard.
 *
 * For information on getting started with BinneyTimothy_Week3 Platform Services,
