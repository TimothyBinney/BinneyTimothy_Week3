...
exports.saveData = function(jsonInfo) {
	...
	data.execute('CREATE TABLE IF NOT EXISTS avfweek3 (id INTEGER PRIMARY KEY,comments INTEGER, time INTEGER, views INTEGER, url TEXT, thumbnail TEXT, title TEXT, owner TEXT)');
	for(var i=0; i<j; i++){
